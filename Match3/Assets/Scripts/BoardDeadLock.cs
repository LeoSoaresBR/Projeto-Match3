...
public class BoardDeadLock : MonoBehaviour
{
    ...
    List<GamePiece> GetRowOrColumnsList(GamePiece[,] allPieces, int x, int y, int listLength = 3, bool checkRow = true)
    {
    ...
    {
        List<GamePiece> pieces = GetRowOrColumnsList(allPieces, x, y, listLength, checkRow);
