...
public class MessageWindow : MonoBehaviour
{
    ...
    {
        if(collectiongGoalLayout !=null)
        {
            collectiongGoalLayout.SetActive(state);
        }
